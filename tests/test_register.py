...
class RegisterTest(unittest.TestCase): 
    ...
    def check_bogoff_discount(self): 
    ...
    def check_strawberries_discount(self): 
    ...
    def check_coffee_discount(self): 
    ...
    def check_order_irrelevant(self): 
